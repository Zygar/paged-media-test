...
export default function Template({
  ...
  React.useEffect(() => {
    ...
    let consolidatedHtml = allMarkdown.map(x => (x.node.html)).join();
    // console.log(consolidatedHtml);
    let fragment = fragmentPrep(consolidatedHtml);
